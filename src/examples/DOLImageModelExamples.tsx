...
import { 
  ...
  DOLImageGIFModel,
  SVGModelConfig 
} from '../components/dol/sprite/dolImageModels';
...
export const ExampleInteractiveModel: React.FC = () => {
  ...
  return (
    <div>
      ...
      {useGIF ? (
        <DOLImageGIFModel config={config} width={300} height={500} />
      ) : (
        <DOLImageSVGModel config={config} width={300} height={500} useImages={true} />
      )}
    </div>
  );
};
