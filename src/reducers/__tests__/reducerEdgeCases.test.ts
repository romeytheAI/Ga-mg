  ...
  it('preserves all player subsystems from payload', () => {
    const savedState: GameState = {
      ...
      player: {
        ...
        quests: [{ id: 'q1', title: 'Test Quest', description: 'test', status: 'active', type: 'main' as const }],
      },
      world: {
        ...initialState.world,
...
describe('gameReducer – START_NEW_GAME', () => {
  ...
  it('resets completed quests', () => {
    const withQuests: GameState = {
      ...
      player: {
        ...initialState.player,
        quests: [{ id: 'q1', title: 'Done Quest', description: 'done', status: 'completed', type: 'main' as const }],
      },
    };
