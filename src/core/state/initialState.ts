import { ClothingLayer, GameState, Item } from '../../core/types';
import { LOCATIONS } from '../../features/world/locations/locations';
import { generateStartingWorld } from '../../features/simulation/systems/ProceduralGen';
import { getDefaultGraphicsQuality } from '../../shared/utils/graphicsQuality';
import { annotateActionsWithChance } from '../../shared/utils/locationEventEngine';
import { computeClothingState } from '../../shared/utils/clothingState';
