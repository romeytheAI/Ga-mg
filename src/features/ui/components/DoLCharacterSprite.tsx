...
import { GameState, Item, Cosmetics, CosmeticScar, CosmeticTattoo, CosmeticPiercing } from '../../../core/types';
import { resolveRace, RacialBodyFeatures } from '../../simulation/systems/races';
