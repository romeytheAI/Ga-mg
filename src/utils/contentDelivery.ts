...
import { TIME_OF_DAY_DESCRIPTIONS, WEATHER_DESCRIPTIONS, TRAVEL_NARRATIVES, IDLE_FLAVOR_TEXT, STAT_REACTIVE_FLAVOR, DREAM_SEQUENCES, RUMOR_MILL, LOADING_SCREEN_TIPS } from '../data/ambientNarrative';
import { ES_ENCOUNTER_VARIANTS, ES_ENCOUNTERS_EXPANDED } from '../data/esEncountersExpanded';
import { NPC_REACTION_VARIANTS } from '../data/npcReactionVariants';
import { QUEST_NARRATIVES } from '../data/questNarratives';
import { ES_NPCS_EXPANDED } from '../data/esNPCsExpanded';
import { ES_LOCATIONS_EXPANDED } from '../data/esLocationsExpanded';
