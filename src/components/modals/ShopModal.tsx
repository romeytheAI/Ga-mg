...
export const ShopModal: React.FC<ShopModalProps> = ({ state, dispatch }) => {
  ...
  return (
    ...
    >
      ...
      >
        <button onClick={() => dispatch({ type: 'TOGGLE_UI_SETTING', payload: { key: 'show_shop', value: false } })} className="absolute top-6 right-6 text-white/40 hover:text-white" aria-label="Close modal">
