  ...
  return (
    ...
    >
      ...
      >
        ...
        {(() => {
          const equipped = state.player.inventory.reduce<{ names: string[], totalIntegrity: number, count: number }>((acc, i) => {
            if (i.is_equipped) {
          ...
          return (
            <div className="mt-8 pt-6 border-t border-white/10">
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono text-white/60">{Math.round(equipped.totalIntegrity / (equipped.count || 1))}%</span>
              </div>
            </div>
          );
        })()}
