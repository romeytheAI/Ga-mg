...
export const StatusModal: React.FC<StatusModalProps> = ({ state, onClose }) => {
  // ⚡ Bolt: Using reduce and useMemo to avoid multiple array allocations
      ...
      >
        ...
        <div className="mt-8 pt-6 border-t border-white/10">
          ...
          <div className="mt-2 flex items-center justify-between">
            ...
            <span className="text-[10px] font-mono text-white/60">{Math.round(equipmentStats.totalIntegrity / (equipmentStats.count || 1))}%</span>
          </div>
        </div>
