            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-white/[0.02] border border-white/5 rounded-sm">
                ...
                {(() => {
                  ...
                  if (!currentLocId) return <span className="text-[10px] text-white/20 italic">No one nearby</span>;
                  const here = npcsByLocation[currentLocId as keyof typeof npcsByLocation] ?? [];
                  if (here.length === 0) {
