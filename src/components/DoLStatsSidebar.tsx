...
import { Heart, Wind, Shield, Flame, Droplets, Sun, Moon, Zap, Coffee, Users, Star, Smile } from 'lucide-react';
  ...
  return (
    <div className="w-52 shrink-0 border-r border-white/[0.06] bg-[#080808] flex flex-col overflow-y-auto scrollbar-hide z-20">
      ...
      <div className="flex-1 px-3 py-2 space-y-0.5">
        ...
        />
        <StatBar
          label="Hygiene" value={life_sim.needs.hygiene}
        ...
        />
        <StatBar
          label="Happiness" value={life_sim.needs.happiness}
          color="bg-green-600" icon={<Smile className="w-3 h-3" />}
          pulseLow
        />

        {/* Daily Activity */}
        <SectionHeader label="Daily Metrics" />
        <div className="px-4 py-2 flex flex-col gap-1.5">
          <div className="flex justify-between text-[10px] tracking-widest uppercase">
            ...
            <span className="text-white/70">{life_sim.schedule.current_activity}</span>
          </div>
          <div className="flex justify-between text-[10px] tracking-widest uppercase">
            <span className="text-white/40">Metabolism</span>
            <span className="text-white/70">{Math.round(life_sim.daily_stats.calories_burned)} kcal</span>
          </div>
          <div className="flex justify-between text-[10px] tracking-widest uppercase">
            <span className="text-white/40">Awake</span>
            <span className="text-white/70">{Math.floor(life_sim.daily_stats.consecutive_awake_hours)}h</span>
          </div>
        </div>
