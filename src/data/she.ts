...
export const ES_WORLD_EVENTS: WorldEvent[] = [
  {
    ...
    effects: [
      { subtype: 'danger_increase', multiplier: 1.5, scope: 'all_locations' },
      { subtype: 'spawn_daedra', frequency: 'every_location', duration: 'event' },
      { subtype: 'player_debuff', stat: 'willpower', amount: -10, reason: 'daedric_pressure' },
    ],
    duration_days: 3,
    world_state_changes: {
  ...
  },
  {
    ...
    effects: [
      { subtype: 'spawn_dragons', frequency: 'outdoor_locations', chance: 0.15 },
      { subtype: 'unlock_npc', npc_id: 'npc_es_paarthurnax' },
      { subtype: 'unlock_location', location_id: 'loc_es_throat_of_world' },
    ],
    duration_days: -1,
    world_state_changes: {
  ...
  },
  {
    ...
    effects: [
      { subtype: 'faction_shift', faction: 'vampires', gain: 'caves', loss: 'none' },
      { subtype: 'faction_shift', faction: 'dawnguard', gain: 'forts', loss: 'none' },
      { subtype: 'route_danger', paths: ['crossroads', 'forest'], multiplier: 1.3 },
    ],
    duration_days: 15,
    world_state_changes: {
  ...
  },
  {
    ...
    effects: [
      ...
      { type: 'player_choice', subtype: 'daedric_pact', princes: ['sanguine', 'vaermina', 'molag_bal'] },
    ],
    duration_days: 7,
    world_state_changes: {
  ...
  },
  {
    ...
    effects: [
      ...
      { type: 'spawn_automata', subtype: ['sphere', 'spider', 'centurion'], frequency: 'dwemer_dungeons' },
      { type: 'salvage_opportunity', subtype: 'dwemer_tech', value: 'high' },
    ],
    duration_days: 5,
    world_state_changes: {
  ...
  },
  {
    ...
    effects: [
      { subtype: 'corruption_increase', rate: 2.0, scope: 'riften' },
      { subtype: 'race_debuff', race: 'argonian', stat: 'stamina', amount: -15 },
      { subtype: 'crime_spike', crime_rate: 1.8, location: 'riften' },
    ],
    duration_days: 10,
    world_state_changes: {
  ...
  },
  {
    ...
    effects: [
      ...
      { type: 'unlock_magic', subtype: 'spirit_magic', duration: 3 },
  ...
  },
  {
    ...
    effects: [
      { subtype: 'random_item_effects', frequency: 'high' },
      { subtype: 'npc_dialogue_scramble', probability: 0.3 },
      { subtype: 'weather_unpredictable', range: 'all_weathers' },
      { subtype: 'player_confusion', probability: 0.15, reason: 'madness_bleed' },
    ],
    duration_days: 14,
    world_state_changes: {
  ...
  },
  {
    ...
    effects: [
      { subtype: 'faction_hostility', faction: 'blades', non_members: 'suspicious' },
      { subtype: 'road_interrogations', frequency: 'medium' },
      { subtype: 'delphine_disposition', state: 'hostile_unless_recruited' },
    ],
    duration_days: -1,
    world_state_changes: {
  ...
  },
  {
    ...
    effects: [
      ...
      { type: 'unlock_shouts', subtype: 'dragon_shout', count: 1 },
