export const LOCATIONS: Record<string, any> = {
  ...
  'temple_gardens': {
    ...
    actions: [
      ...
      { id: 'tend_garden', label: "Help tend the gardens", intent: "work", outcome: "The priests welcome your help weeding and watering the flower beds. The honest labor in the sunshine feels good.", stat_deltas: { stamina: -15, stress: -10, purity: 3 }, skill_deltas: { housekeeping: 2 }, hours_passed: 2 },
