export const LOCATIONS: Record<string, any> = {
  ...
  'town_square': {
    ...
    actions: [
      ...
      { id: 'buy_food', label: "Buy a hot meal from a vendor", intent: "neutral", outcome: "You spend a coin on a bowl of steaming mutton stew from a street vendor. It's the best thing you've eaten in weeks. The warmth spreads through your belly and lifts your spirits.", stat_deltas: { stamina: 10, stress: -10 } },
