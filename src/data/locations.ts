export const LOCATIONS: Record<string, any> = {
  ...
  'arenthia': {
    ...
    actions: [
      { id: 'work_docks_arenthia', label: "Haul cargo on the river docks", intent: "work", skill_check: { stat: "stamina", difficulty: 45 }, outcome: "You sweat under the harsh sun, loading heavy crates onto riverboats heading for the Abecean Sea. The pay is good, though.", fail_outcome: "The heat is too much. You drop a crate of spices, angering a Khajiit merchant who refuses to pay you.", stat_deltas: { stamina: -20, stress: 5 }, fail_stat_deltas: { stamina: -25, stress: 15, pain: 5 }, skill_deltas: { athletics: 2 }, new_items: [{ name: "Gold Coin", type: "misc", rarity: "common", description: "The currency of the realm." }, { name: "Gold Coin", type: "misc", rarity: "common", description: "The currency of the realm." }], hours_passed: 4 },
