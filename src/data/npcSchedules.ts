...
export const NPC_SCHEDULES: Record<string, NpcSchedule> = {
  ...
  robin: {
    ...
    slots: [
      ...
      { label: 'At school',             location_id: 'school',      time: { from: 8,  to: 15 }, conditions: { days_of_week: WEEKDAYS } },
  ...
  whitney: {
    npc_id: 'whitney',
    slots: [
      { label: 'Morning prep',         location_id: 'school',      time: { from: 7,  to: 8  }, conditions: { days_of_week: WEEKDAYS } },
      { label: 'Classes',              location_id: 'school',      time: { from: 8,  to: 15 }, conditions: { days_of_week: WEEKDAYS } },
      { label: 'After school bullying',location_id: 'alleyways',   time: { from: 15, to: 17 }, conditions: { days_of_week: WEEKDAYS } },
      { label: 'Weekend town',         location_id: 'town_square', time: { from: 10, to: 16 }, conditions: { days_of_week: WEEKEND } },
      { label: 'Evening park',         location_id: 'park',        time: { from: 17, to: 20 } },
  ...
  kylar: {
    npc_id: 'kylar',
    slots: [
      { label: 'Early library',        location_id: 'school',      time: { from: 6,  to: 8  } },
      { label: 'Classes',              location_id: 'school',      time: { from: 8,  to: 15 }, conditions: { days_of_week: WEEKDAYS } },
      { label: 'Watching the player',  location_id: 'park',        time: { from: 15, to: 18 } },
      { label: 'Evening vigil',        location_id: 'alleyways',   time: { from: 19, to: 22 } },
      { label: 'Sleeping',             location_id: 'school',      time: { from: 22, to: 24 } },
  ...
  avery: {
    npc_id: 'avery',
    slots: [
      { label: 'Breakfast',            location_id: 'school',      time: { from: 7,  to: 8  }, conditions: { days_of_week: WEEKDAYS } },
      { label: 'Classes',              location_id: 'school',      time: { from: 8,  to: 15 }, conditions: { days_of_week: WEEKDAYS } },
      { label: 'Sports practice',      location_id: 'school',      time: { from: 15, to: 17 }, conditions: { days_of_week: WEEKDAYS } },
      { label: 'Town square hangout',  location_id: 'town_square', time: { from: 17, to: 20 } },
      { label: 'Weekend town',         location_id: 'town_square', time: { from: 9,  to: 18 }, conditions: { days_of_week: WEEKEND } },
  ...
  sydney: {
    ...
    slots: [
      { label: 'Classes',              location_id: 'school',      time: { from: 8,  to: 15 }, conditions: { days_of_week: WEEKDAYS } },
      { label: 'Study hall',           location_id: 'school',      time: { from: 15, to: 17 }, conditions: { days_of_week: WEEKDAYS } },
      { label: 'Temple visit',         location_id: 'temple_gardens', time: { from: 17, to: 19 } },
  ...
  leighton: {
    ...
    slots: [
      ...
      { label: 'Faculty office',       location_id: 'school',      time: { from: 17, to: 19 } },
      { label: 'Shopping',             location_id: 'shopping_centre', time: { from: 10, to: 14 }, conditions: { days_of_week: WEEKEND } },
      { label: 'Sleeping',             location_id: 'school',      time: { from: 21, to: 24 } },
      { label: 'Sleeping',             location_id: 'school',      time: { from: 0,  to: 8  } },
    ],
  },
  ...
  river: {
    ...
    slots: [
      ...
      { label: 'Lake visit',           location_id: 'lake',        time: { from: 14, to: 17 }, conditions: { days_of_week: WEEKEND } },
      { label: 'Evening walk',         location_id: 'forest',      time: { from: 18, to: 20 } },
      { label: 'Sleeping',             location_id: 'school',      time: { from: 22, to: 24 } },
      { label: 'Sleeping',             location_id: 'school',      time: { from: 0,  to: 8  } },
    ],
  },
  ...
  doren: {
    ...
    slots: [
      ...
      { label: 'Grading papers',       location_id: 'school',      time: { from: 16, to: 18 } },
      { label: 'Town errands',         location_id: 'town_square', time: { from: 10, to: 13 }, conditions: { days_of_week: WEEKEND } },
      { label: 'Sleeping',             location_id: 'school',      time: { from: 21, to: 24 } },
      { label: 'Sleeping',             location_id: 'school',      time: { from: 0,  to: 8  } },
    ],
  },
  ...
  mason: {
    ...
    slots: [
      { label: 'Classes',              location_id: 'school',      time: { from: 8,  to: 15 }, conditions: { days_of_week: WEEKDAYS } },
      { label: 'Underground market',   location_id: 'underground_market', time: { from: 16, to: 20 } },
      { label: 'Weekend deals',        location_id: 'underground_market', time: { from: 10, to: 18 }, conditions: { days_of_week: WEEKEND } },
      { label: 'Alley operations',     location_id: 'alleyways',   time: { from: 20, to: 23 } },
