...
export const ES_WORLD_EVENTS: WorldEvent[] = [
  ...
  },
  {
    ...
    effects: [
      ...
      { type: 'player_choice', choices: [], princes: ['sanguine', 'vaermina', 'molag_bal'] },
    ],
    duration_days: 7,
    world_state_changes: {
  ...
  },
  {
    ...
    effects: [
      ...
      { type: 'spawn_automata', automata_subtype: ['sphere', 'spider', 'centurion'], frequency: 'dwemer_dungeons' },
      { type: 'salvage_opportunity', salvage_subtype: 'dwemer_tech', value: 'high' },
    ],
    duration_days: 5,
    world_state_changes: {
  ...
  },
  {
    ...
    effects: [
      ...
      { type: 'unlock_magic', magic_subtype: 'spirit_magic', duration: 3 },
