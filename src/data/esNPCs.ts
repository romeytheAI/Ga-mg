export const ES_NPCS: Record<string, any> = {
  ...
  npc_es_vivec: {
    ...
    schedule: [
      { time: 0, location: 'loc_es_vivec_city', action: 'meditating' },
      { time: 6, location: 'loc_es_vivec_city', action: 'maintaining_ghostfence' },
      { time: 12, location: 'loc_es_vivec_city', action: 'writing_sermons' },
      { time: 18, location: 'loc_es_vivec_city', action: 'holding_baar_dau' },
    ],
    relationship: 0,
    is_romanceable: false,
  ...
  npc_es_caius_cosades: {
    ...
    schedule: [
      { time: 0, location: 'loc_es_balmora', action: 'sleeping' },
      { time: 8, location: 'loc_es_balmora', action: 'reading_reports' },
      { time: 14, location: 'loc_es_balmora', action: 'gathering_intel' },
      { time: 18, location: 'loc_es_balmora', action: 'smoking_skooma' },
    ],
    relationship: 0,
    is_romanceable: false,
  ...
  npc_es_neloth: {
    ...
    schedule: [
      ...
      { time: 22, location: 'loc_es_sadrith_mora', action: 'reading_black_books' },
    ],
    relationship: 0,
    is_romanceable: false,
    tags: ['telvanni', 'wizard', 'dunmer', 'vardenfell'],
  },
};
