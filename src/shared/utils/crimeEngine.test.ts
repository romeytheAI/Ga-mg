...
import { defaultCriminalRecord } from '../../features/simulation/systems/CrimeSystem';
import type { CriminalRecord, FactionId, GuardAlertLevel } from '../../features/simulation/systems/types';
